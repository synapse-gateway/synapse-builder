...
import ExternalModule_3 from './sources/books/oas-schema.js';
const importedModules = {
    ...
    // @ts-ignore
    [".mesh/sources/books/oas-schema.js"]: ExternalModule_3
};
...
export const rawConfig = { "sources": [{ "name": "books", "handler": { "openapi": { "source": "./openapi-schemas/books-schema.yaml" } } }] };
