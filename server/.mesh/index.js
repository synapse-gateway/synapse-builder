...
const oas_schema_js_1 = (0, tslib_1.__importDefault)(require("./sources/Bored/oas-schema.js"));
const oas_schema_js_2 = (0, tslib_1.__importDefault)(require("./sources/Yoda/oas-schema.js"));
const importedModules = {
    ...
    // @ts-ignore
    [".mesh/sources/Bored/oas-schema.js"]: oas_schema_js_1.default,
    // @ts-ignore
    [".mesh/sources/Yoda/oas-schema.js"]: oas_schema_js_2.default
};
...
exports.rawConfig = { "sources": [{ "name": "Bored", "handler": { "openapi": { "source": "http://www.boredapi.com/api/activity/" } } }, { "name": "Yoda", "handler": { "openapi": { "source": "http://www.boredapi.com/api/activity/" } } }] };
async function getMeshOptions() {
    ...
    const boredHandler = new openapi_2.default({
    ...
    const yodaHandler = new openapi_2.default({
