...
exports.rawConfig = { "sources": [{ "name": "BookService", "handler": { "openapi": { "source": "./oas_books.yaml" } } }, { "name": "AuthorService", "handler": { "openapi": { "source": "./oas_authors.yaml" } } }] };
async function getMeshOptions() {
    ...
    const bookServiceHandler = new openapi_2.default({
